...
_SUBCOMMANDS = (
    ("review", "Read-only deterministic bounded skill audit", _cmd_review,
     _arg("--json", action="store_true"),
     _arg("--max-skills", type=int, default=5000),
     _arg("--baseline", metavar="PATH", help="Compare with a prior local JSON report")),
